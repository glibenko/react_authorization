...
console.log('meConfigMongodbServer', meConfigMongodbServer);
meConfigMongodbServer = ['mongodb://localhost:27017/db'];

module.exports = {
  mongodb: {
    // if a connection string options such as server/port/etc are ignored
    connectionString: mongo.connectionString || 'mongodb://localhost:27017/db',
